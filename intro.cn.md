...
那我为什不叫它《Go语言进阶》，或者《Go语言实战》呢？坦白地回想的话，一方面这种名字的书已经有了，我取类似的名字，就不够标新立异了，怎么卖得出去？另一方面，“日常”这两个字，确实能体现它的特色：
...
这本书是我的个人工程开发的配套书籍，因此记录的都是我——作为一个Go语言程序员——所遇到、关注、感兴趣、担心的问题，并记录我的观察、搜索、解决和心情。这是一个自己与自己对话的过程，一个技术与内心积累的过程。
...
## 这本书配套的应用,NeoReads,是什么样的,为何能涉及到这么多话题
